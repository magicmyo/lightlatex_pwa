...
// Task 6: focused port of Overleaf's figure-modal FigureData model + the
// edit-figure state field. The full figure modal UI (file tree integration,
// paste-image handling, metadata effects) is deferred to a later task; only the
// data model and effect/state field consumed by the visual decorations are
// ported here.
