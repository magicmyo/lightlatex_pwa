...
const features: { icon: string; text: string }[] = [
  ...
  { icon: '✏️', text: 'Rich Code editor (CodeMirror) and Visual (WYSIWYG) editor — web-based TeX editing at its best' },
  { icon: '🗂️', text: 'File tree, document outline, and multi-file project support' },
  { icon: '📦', text: 'ZIP import and export — use projects from Overleaf or any LaTeX editor' },
  { icon: '🔒', text: 'Privacy-first: all projects stored locally in your browser — nothing is ever uploaded' },
]
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: '0 0 40px', fontSize: '16px', color: '#8b949e', textAlign: 'center', maxWidth: '500px' }}>
        ...
        <strong style={{ color: '#c9d1d9', fontWeight: 600 }}>Overleaf alternative</strong> — compile LaTeX to PDF
        entirely in your browser, works fully{' '}
